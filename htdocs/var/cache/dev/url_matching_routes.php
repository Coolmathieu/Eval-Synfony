...
return [
    ...
    [ // $dynamicRoutes
        ...
        71 => [[['_route' => 'app_citation_show', '_controller' => 'App\\Controller\\CitationController::show'], ['id'], ['GET' => 0], null, false, true, null]],
        101 => [
            [['_route' => 'app_citation_edit', '_controller' => 'App\\Controller\\CitationController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, true, null],
